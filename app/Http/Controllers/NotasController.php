...
class NotasController extends Controller
{
    ...
    public function HistorialNotaRecepcion($mesOffset = 1)
    {
        $rut = Auth::user()->rut;
        ...
        try {
            ...
            if (empty($estructuraCarpetas)) {
                return view('Notas.mesanterior', [
                    'error' => 'No se encontraron registros para el mes seleccionado.',
                    'mesActual' => $mesActual,
            ...
            return view('Notas.mesanterior', [
                'error' => 'Ocurrió un error al obtener los archivos PDF.',
                'mesActual' => $mesActual,
                'totalKilos' => $totalKilos,
                'estructuraCarpetas' => [],
            ]);
